...
import { register, login, readUsers, readUser, editUser, removeUser, confirmEmail } from "./user_controller.js";
import { validation } from "./user_middleware.js";
import { userSchema, loginSchema } from "./user_validation.js";
import { checkEmailOrPhoneExists, checkEmailOrPhoneForLogin } from "./user_middleware.js";
...
// Public routes
userRouter.post("/register", validation(userSchema), checkEmailOrPhoneExists, hashPassword, register);
userRouter.post("/login", validation(loginSchema), checkEmailOrPhoneForLogin, comparePassword, login);
